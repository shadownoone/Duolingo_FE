...
export const LessonTopBarHeart = ({ className = "", ...props }) => {
  return (
    <svg
      className={className}
      width="28"
    ...
    >
      <g fill="none">
        ...
        <path
          ...
          fill="#F89701"
        />
        <path d="M32.414 20.95L13.363 40" stroke="#ED8200" />
      </g>
    </svg>
  );
};

export const SiverSvg = (props) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="53"
...
export const DuolingoVip = (props) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="36"
    ...
    >
      <path
        d="M3.5 14.9911C3.5 17.6891 4.86751 20.0748 6.96175 21.5216L15.8933 29.3143C16.9544 30.2401 18.5397 30.2277 19.5862 29.2856L28.5687 21.1987C30.4148 19.7337 31.5946 17.4971 31.5946 14.9911C31.5946 10.578 27.9359 7.00049 23.4226 7.00049C21.1163 7.00049 19.0332 7.93463 17.5473 9.43705C16.0615 7.93463 13.9783 7.00049 11.6721 7.00049C7.15876 7.00049 3.5 10.578 3.5 14.9911Z"
        fill="url(#paint0_linear_683_43331)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M15.9965 19.695C14.5798 21.1116 12.283 21.1116 10.8663 19.695C9.44969 18.2783 9.44969 15.9815 10.8663 14.5648C12.283 13.1482 14.5798 13.1482 15.9965 14.5648L18.5615 17.1299L15.9965 19.695ZM12.116 18.4453C12.8425 19.1718 14.0203 19.1718 14.7468 18.4453L16.0622 17.1299L14.7468 15.8145C14.0203 15.088 12.8425 15.088 12.116 15.8145C11.3895 16.541 11.3895 17.7188 12.116 18.4453Z"
        fill="#FEFEFE"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M18.7721 19.695C20.1887 21.1116 22.4856 21.1116 23.9022 19.695C25.3189 18.2783 25.3189 15.9815 23.9022 14.5648C22.4856 13.1482 20.1887 13.1482 18.7721 14.5648L16.207 17.1299L18.7721 19.695ZM22.6526 18.4453C21.9261 19.1718 20.7482 19.1718 20.0217 18.4453L18.7063 17.1299L20.0217 15.8145C20.7482 15.088 21.9261 15.088 22.6526 15.8145C23.3791 16.541 23.3791 17.7188 22.6526 18.4453Z"
        fill="#FEFEFE"
      />
      <defs>
        <linearGradient
          id="paint0_linear_683_43331"
          x1="12.9744"
          y1="7.00049"
          x2="20.334"
          y2="32.0915"
        ...
        >
          <stop stopColor="#26F663" />
          <stop offset="0.601579" stopColor="#268AFF" />
          <stop offset="0.940172" stopColor="#FC55FF" />
        </linearGradient>
      </defs>
    </svg>
  );
...
export const StreakFreeze = (props) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="95"
    ...
    >
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M53.8174 2.79555L92.8736 58.9489C94.1212 60.7426 94.7899 62.8753 94.7899 65.0602V87.2485C94.7899 89.742 93.9194 92.1571 92.3286 94.0771L72.7192 117.744C71.2668 119.497 69.1088 120.512 66.8323 120.512H36.73C35.1246 120.512 33.5599 120.006 32.2579 119.067L2.91461 97.903C1.32071 96.7534 0.376343 94.9078 0.376343 92.9426V22.8841C0.376343 19.5064 3.11457 16.7681 6.49234 16.7681C7.16026 16.7681 7.82367 16.8775 8.45622 17.092L27.4065 23.5173L43.9956 2.49866C46.0882 -0.15278 49.9341 -0.605752 52.5855 1.48691C53.0583 1.86008 53.4734 2.30106 53.8174 2.79555Z"
        fill="#71D2FF"
      />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M23.8009 122.412C23.5082 122.988 23.0833 123.466 22.5705 123.795C20.9875 124.812 18.9718 124.192 18.0683 122.412L6.46777 99.5516H35.4014L23.8009 122.412Z"
        fill="#71D2FF"
      />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M44.4876 136.078C44.1451 137.357 43.1491 138.357 41.874 138.7C39.9002 139.232 37.8704 138.058 37.3401 136.078L29.6176 107.245H52.2102L44.4876 136.078Z"
        fill="#71D2FF"
      />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M86.0659 122.956C84.3445 124.061 82.056 123.557 80.9544 121.831L72.5203 108.612L94.411 89.3135L87.6817 120.644C87.468 121.598 86.8873 122.429 86.0659 122.956Z"
        fill="#71D2FF"
      />
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M14.3796 67.5944L14.1066 41.1977C14.0656 37.2403 16.1808 34.3373 19.8393 34.986C20.5683 35.1153 22.1111 35.5946 22.8036 35.972L30.4273 40.1273L39.9487 27.9146C42.9084 24.1182 48.3854 23.44 52.1817 26.3997C52.7471 26.8405 53.2559 27.3493 53.6966 27.9146L70.9585 50.0558C71.1295 50.2751 71.2762 50.5057 71.399 50.7442C76.4807 56.396 79.5633 63.8146 79.5633 71.9386C79.5633 89.6542 64.9048 104.015 46.8226 104.015C28.7404 104.015 14.0819 89.6542 14.0819 71.9386C14.0819 70.4652 14.1833 69.015 14.3796 67.5944Z"
        fill="#1CB0F6"
      />
      <path
        opacity="0.75"
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M37.161 74.4074C37.2175 74.2257 37.3042 74.0536 37.4186 73.8985L43.9578 65.0329C45.0831 63.5073 47.2322 63.1828 48.7578 64.3081C49.0343 64.5121 49.2787 64.7564 49.4827 65.0329L56.0219 73.8985C56.0486 73.9347 56.0737 73.9717 56.0971 74.0092C58.3679 76.2451 59.7667 79.2991 59.7667 82.6664C59.7667 89.5204 53.9714 95.0767 46.8227 95.0767C39.6739 95.0767 33.8787 89.5204 33.8787 82.6664C33.8787 79.4949 35.1195 76.6013 37.161 74.4074Z"
        fill="#1CDAF6"
      />
      <path
        opacity="0.592857"
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M11.0296 23.5328L30.7271 30.6455L46.1642 7.58778C47.1038 6.18438 49.0031 5.80837 50.4066 6.74795C50.7467 6.9757 51.0377 7.26944 51.2623 7.61175L70.6673 37.1943C71.5231 38.4989 71.2595 40.2385 70.0556 41.2311L11.9363 89.1477C10.6332 90.222 8.70584 90.0366 7.63149 88.7335C7.17993 88.1858 6.93298 87.498 6.93298 86.7882V26.409C6.93298 24.7201 8.3021 23.351 9.99098 23.351C10.3451 23.351 10.6965 23.4125 11.0296 23.5328Z"
        fill="#B4E7FF"
      />
      <path
        d="M26.3819 47.7621L19.5762 40.9564C18.979 40.3593 18.0109 40.3593 17.4138 40.9564L10.5807 47.7895C9.98363 48.3866 9.98363 49.3547 10.5807 49.9518L17.3865 56.7575C17.9836 57.3547 18.9517 57.3547 19.5488 56.7575L26.3819 49.9245C26.979 49.3273 26.979 48.3592 26.3819 47.7621Z"
        fill="white"
      />
      <path
        opacity="0.592857"
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M89.1627 86.0366L68.013 111.571C67.432 112.272 66.5687 112.678 65.6579 112.678H48.0209C46.332 112.678 44.9629 111.309 44.9629 109.62C44.9629 108.836 45.2639 108.082 45.8039 107.514L84.5907 66.6866C85.7539 65.4622 87.6895 65.4126 88.9139 66.5758C89.5216 67.1532 89.8657 67.9547 89.8657 68.7929V84.0859C89.8657 84.7982 89.6171 85.4881 89.1627 86.0366Z"
        fill="#B4E7FF"
      />
      <path
        d="M79.8458 79.843L75.5784 75.5756C74.9812 74.9784 74.0131 74.9784 73.416 75.5756L69.129 79.8626C68.5318 80.4597 68.5318 81.4278 69.129 82.025L73.3964 86.2924C73.9935 86.8895 74.9616 86.8895 75.5587 86.2924L79.8458 82.0053C80.4429 81.4082 80.4429 80.4401 79.8458 79.843Z"
        fill="white"
      />
    </svg>
  );
